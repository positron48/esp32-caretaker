...
<head>
    ...
    <style>
        ...
        * {
        ...
        .bt-status.status-connected::before {
        ...
        .bt-status.status-disconnected::before {
        ...
        .bt-status.status-scanning::before {
    ...
    <div class="container">
        ...
        <div class="settings-panel" id="settings-panel">
            ...
            <div class="settings-section">
                ...
                <div class="bt-status">
                    <span class="bt-status-icon"></span>
                    <span class="bt-status-text">Bluetooth: Выключен</span>
                </div>
            </div>
        ...
        function checkBluetoothStatus() {
            fetch('/bt/status')
                ...
                .then(data => {
                    ...
                    const btStatusText = document.querySelector('.bt-status-text') || btStatusElement;
                    btStatusText.textContent = data.status;
