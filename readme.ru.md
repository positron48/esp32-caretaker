...
* **Несколько методов управления:**
  ...
  * **Клавиатура (WASD/стрелки или "цфыв"):** Управление с клавиатуры с визуальной отдачей
...
2. **Элементы управления веб-интерфейса:**
   ...
   * **Клавиатура (WASD/стрелки или "цфыв")** - Используйте клавиши для движения, интерфейс отражает действия
